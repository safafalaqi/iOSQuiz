...
//  iOSQuiz
//
//  Created by Safa Falaqi on 30/11/2021.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var answerLablel: UILabel!
    ...
    @IBAction func answerButtonPressedcopy(_ sender: UIButton) {
        // if answerLabel is not hidden, then make it hiddencopy
        if answerLablel.isHidden == false {
            answerLablel.isHidden = true
        }else {  // else set it not hidden
            answerLablel.isHidden = false
        }
    }
    
    @IBAction func nextButtonPressedcopy(_ sender: UIButton) {
    ...
    func updateUI() {
        ...
        answerLablel.text =  quizBank[currentQuestion].1
            // then set answerLabel to be hidden
        answerLablel.isHidden = true
        }
    override func viewDidLoad() {
        super.viewDidLoad()
        //to and rounded corners to the blur view 
